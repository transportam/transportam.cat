    ...
    >
      ...
      >
        ...
        <div class="mt-8 flex flex-col gap-4">
          <NuxtLink
            class="inline-flex justify-center rounded-lg py-2 px-3 text-sm font-semibold transition-colors bg-neutral-800 text-white hover:bg-neutral-900 active:bg-neutral-800 active:text-white/80"
            to="/download"
          >
            Descarregar
          </NuxtLink>
